...
import com.jingyu.pay.ui.notifications.PersonalDateModel
...
class NewsListDateModel {


    var BaseUrl : String = Constant.API_URL
    fun getNewsLList(context: Context,groupResponse: GroupResponse){
...
//        val client = OkHttpClient()
        ...
        val request = Request.Builder()
            .url(BaseUrl + "api/user/Announcements")
            .get()
