...
public class AddToCardDialog extends AlertDialog {
    ...
    public AddToCardDialog(Activity activity) {
        super(activity);
        this.activity = activity;
    }


    protected AddToCardDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
    }

    protected AddToCardDialog(Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(activity).inflate(R.layout.add_tobank_card, null);
        setView(view);
        setContentView(view);
