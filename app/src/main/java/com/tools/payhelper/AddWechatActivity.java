...
public class AddWechatActivity extends AppCompatActivity implements View.OnClickListener {
...
//        btn_album.setOnClickListener(this);
        ...
        findViewById(R.id.okBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean b = ischeck;
                bankCardDateModel.setBankCard(AddWechatActivity.this, n, p, t, payF, google, username, euserName,ischeck,"",false,0,0, new BankCardDateModel.BankCardResponse() {
                    @Override
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        if (addBankCardData.code==0){
                                            ToastManager.showToastCenter(AddWechatActivity.this,addBankCardData.msg);
                                            AddWechatActivity.this.finish();
