...
public class UpadteAddWechatActivity extends AppCompatActivity implements View.OnClickListener {
...
//        btn_album.setOnClickListener(this);
        ...
        findViewById(R.id.closeBtn).setOnClickListener(v -> {
            UpadteAddWechatActivity.this.finish();
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        if (addBankCardData.code==0){
                                            ToastManager.showToastCenter(UpadteAddWechatActivity.this,addBankCardData.msg);
                                            UpadteAddWechatActivity.this.finish();
