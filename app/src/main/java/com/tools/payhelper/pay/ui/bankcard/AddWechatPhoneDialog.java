...
public class AddWechatPhoneDialog extends AlertDialog {
    ...
    public AddWechatPhoneDialog(Activity activity) {
        super(activity);
        this.activity = activity;
    }


    protected AddWechatPhoneDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
    }

    protected AddWechatPhoneDialog(Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.okBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bankCardDateModel.setBankCard(activity, n, p, t, payF, google, username, euserName,ischeck,"",false,0,0, new BankCardDateModel.BankCardResponse() {
                    @Override
