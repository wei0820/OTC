...
class BuyUsdtActivity : BasicActivity() {
            ...
            loginViewModel._version.collect {
                if (it!=null){
                    if(it.data.quality!=null){
                        PayHelperUtils.saveQuality(this@BuyUsdtActivity,it.data.quality)
                    }
                }

                if (PayHelperUtils.getVersionCode()<it.data.versionCode){
                    val dialog = UpdateAlertDialog(this@BuyUsdtActivity,it.data.url)
