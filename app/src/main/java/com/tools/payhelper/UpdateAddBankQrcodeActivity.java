...
public class UpdateAddBankQrcodeActivity extends AppCompatActivity implements View.OnClickListener {
...
//        btn_album.setOnClickListener(this);
        ...
        findViewById(R.id.closeBtn).setOnClickListener(v -> {
            UpdateAddBankQrcodeActivity.this.finish();
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        if (addBankCardData.code==0){
                                            ToastManager.showToastCenter(UpdateAddBankQrcodeActivity.this,addBankCardData.msg);
                                            UpdateAddBankQrcodeActivity.this.finish();
